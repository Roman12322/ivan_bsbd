    ...
    public partial class diagnostic_card : Form
    {
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_connection.Open();
                string sqlcommand = "INSERT INTO diagnostic_card (state, id_car, id_customer, id_employee) VALUES (@state, @id_car, @id_customer, @id_employee)";
                SqlCommand command = sql_connection.CreateCommand();
                ...
                command.Parameters.AddWithValue("@id_customer", Convert.ToInt32(idcust_txt.Text));
                command.Parameters.AddWithValue("@id_employee", Convert.ToInt32(idempl_txt.Text));
                command.ExecuteNonQuery();
                dataGridView1.DataSource = FillDataGridView("select * FROM diagnostic_card");
